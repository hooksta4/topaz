...
function checkReqs(player, npc, bfid, registrant)
    ...
    local registerReqs =
    {
        ...
        [1057] = function() return ( cop == player:getQuestStatus(JEUNO, tpz.quest.id.jeuno.APOCALYPSE_NIGH) == QUEST_ACCEPTED and player:getCharVar('ApocalypseNigh') == 4 ) end, -- Apocalypse Nigh  
